...
{
    public partial class RecuperarContraAbmin : System.Web.UI.Page
    {
            ...
            if (tb.Rows.Count != 0)
            {
                for (int i = 0; i < tb.Rows.Count; i++)
                {
                    if (tb.Rows[i][0].ToString().Trim().FirstOrDefault() != 0)
                    {
                        ...
                        Correo.From = new MailAddress("henryderaslopez@gmail.com");
                        ...
                        txtEnviada.Text = "Contraseña Restablecida Porfabor Revisar Su correo";

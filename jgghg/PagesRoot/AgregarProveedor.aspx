    ...
    <div style="margin: 10% 0% 10% 0%; text-align:center"  class="container">
        ...
        <div class="row">
            <div class="col-md-6 mb-2">
                 ...
                 &nbsp;<asp:TextBox ID="txtProveedorID" runat="server" placeholder="Ingrese ID del Proveedor" CssClass="form-control" required=""></asp:TextBox>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-2">
                <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="txtDepa" CssClass="auto-style2" ErrorMessage="Ingrese solo letras" ValidationExpression="^[a-zA-Z]+$" ForeColor="Red"></asp:RegularExpressionValidator>
                 &nbsp;<asp:TextBox ID="txtDepa" runat="server" placeholder="Ingrese Empresa" CssClass="form-control" required=""></asp:TextBox>
            </div>
        </div>
        <div style="text-align:center">
            <asp:Button ID="Button1" runat="server" Text="Agregar" CssClass="btn btn-dark" OnClick="Button1_Click" required="" type="submit"/>
        </div>

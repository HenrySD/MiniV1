        ...
        <div class="container" style="margin: 10% 0% 10% 0%">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                 ...
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTotal" ErrorMessage="precionar el boton calcular primero" ValidationGroup="total"></asp:RequiredFieldValidator>
                </div>
            ...
            &nbsp;<asp:Button ID="Calcular" runat="server" CssClass="btn btn-dark mt-3 " Text="Calcular total" OnClick="Calcular_Click" />

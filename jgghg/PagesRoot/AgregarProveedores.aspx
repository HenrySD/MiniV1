<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Root.Master" AutoEventWireup="true" CodeBehind="AgregarProveedores.aspx.cs" Inherits="jgghg.PagesRoot.AgregarPoveedores" %>
        ...
        <form class="container" novalidate="" runat="server" id="validar">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">                
                    ...
                    &nbsp;<asp:TextBox ID="txtDepartamento" runat="server" CssClass="form-control" placeholder="Ingrese Departamento" value="" required=""></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    &nbsp;<asp:TextBox ID="txtCodigoPostal" runat="server"  CssClass="form-control" placeholder="Ingrese Codigo Postal" value="" required=""></asp:TextBox>
                ...
                <div class="col-md-4 mb-3">
                     ...
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="txtCell" CssClass="auto-style2" ErrorMessage="Ingrese solo Numeros" ValidationExpression="^[a-zA-Z]+$" Style="color: #FF0000"></asp:RegularExpressionValidator>
                ...
                <div class="col-md-4 mb-3">
                     <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="txtEmpresa" CssClass="auto-style2" ErrorMessage="Ingrese solo letras" ValidationExpression="^[a-zA-Z]+$" Style="color: #FF0000"></asp:RegularExpressionValidator>
                    &nbsp;<asp:TextBox ID="txtEmpresa" runat="server"  CssClass="form-control" placeholder="Ingrese Empresa" value="" required=""></asp:TextBox>
